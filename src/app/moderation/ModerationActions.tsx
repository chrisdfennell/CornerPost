  ...
  return (
    <div className="flex shrink-0 gap-2">
      <button
        onClick={() => act("resolve")}
        disabled={busy !== "none"}
        className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-ink transition hover:border-brand-300 disabled:opacity-60"
      >
